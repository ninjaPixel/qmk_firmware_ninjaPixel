...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    KC_GRV,  KC_X,    KC_2,    KC_3,    KC_4,    KC_GRV,                                       KC_6,    KC_7,    KC_8,     KC_9,    KC_0,    KC_F12,
    CW_TOGG, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                                    KC_CIRC, KC_LEFT, KC_DOWN,  KC_UP,   KC_RIGHT, KC_PIPE,
