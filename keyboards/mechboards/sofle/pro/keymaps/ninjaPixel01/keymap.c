...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    TD(TD_ESC_CAPS),  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                                       KC_6,           KC_7,    KC_8,     KC_9,   KC_0,       LALT(KC_TAB),
    KC_ESC,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,                                       KC_J,           KC_L,    KC_U,     KC_Y,   KC_BSLS,    LALT(KC_BSPC),
  ...
  [1] = LAYOUT(
    ...
    _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                                    KC_CIRC, KC_LEFT, KC_DOWN,  KC_UP,   KC_RIGHT, KC_PIPE,
